...
_TOPIC_PANELS: Dict[str, List[Dict[str, str]]] = {
    "admission": [
        {
            ...
            "question": "Total hospital admissions per month last 12 months",
            "chart_hint": "line",
        },
        {
            "title": "Admissions by Department",
            "question": "Total admissions by department last 90 days",
            "chart_hint": "bar",
        },
        {
            "title": "Admission Type Breakdown",
            "question": "Breakdown of inpatient vs outpatient vs emergency encounters",
            "chart_hint": "pie",
        },
        {
    ...
    "readmission": [
        {
            "title": "30-day Readmission Trend",
            "question": "Monthly 30-day readmission count last 12 months",
            "chart_hint": "line",
        },
        {
            "title": "Readmissions by Dept",
            "question": "30-day readmission count by department",
            "chart_hint": "bar",
        },
        {
            "title": "Top Readmission Diagnoses",
            "question": "Top 5 diagnoses associated with readmissions",
            "chart_hint": "bar",
        },
    ],
    "diagnosis": [
        {
            "title": "Top Diagnoses",
            "question": "Top 10 diagnoses by frequency this quarter",
            "chart_hint": "bar",
        },
        {
            "title": "Diagnoses by Dept",
            "question": "Top diagnoses per department",
            "chart_hint": "table",
        },
        {
            "title": "Diagnosis Trend",
            "question": "Monthly diagnosis count last 6 months",
            "chart_hint": "line",
        },
    ],
    "medication": [
        {
            "title": "Most Prescribed Meds",
            "question": "Top 10 most prescribed medications",
            "chart_hint": "bar",
        },
        {
            "title": "Medication Trend",
            "question": "Monthly medication orders last 6 months",
            "chart_hint": "line",
        },
        {
            "title": "Meds by Department",
            "question": "Medication counts by department",
            "chart_hint": "pie",
        },
    ],
    "lab": [
        {
            "title": "Lab Test Volume",
            "question": "Total lab tests per month last 6 months",
            "chart_hint": "line",
        },
        {
            "title": "Abnormal Lab Results",
            "question": "Count of abnormal lab results by test type",
            "chart_hint": "bar",
        },
        {
            "title": "Lab Results by Dept",
            "question": "Lab test counts by department",
            "chart_hint": "bar",
        },
    ],
    "default": [
        {
            "title": "Encounter Trends",
            "question": "Monthly encounter count last 12 months",
            "chart_hint": "line",
        },
        {
            "title": "Encounters by Department",
            "question": "Total encounters by department last 90 days",
            "chart_hint": "bar",
        },
        {
            "title": "Patient Demographics",
            "question": "Patient count by gender",
            "chart_hint": "pie",
        },
        {
            "title": "Encounter Types",
            "question": "Breakdown of encounter types",
            "chart_hint": "pie",
        },
    ],
}
...
async def _execute_panel(
    ...
    if not validation.is_valid:
        return DashboardPanel(
            ...
            subtitle=question,
            sql=sql,
            error=f"Validation: {'; '.join(validation.violations[:2])}",
            size=CHART_SPANS.get(chart_hint, DEFAULT_SPAN),
        )
    ...
    if (
        chart_hint in {"line", "bar", "pie", "scatter", "heatmap"}
        and chart_type != chart_hint
    ):
    ...
    if rows:
        ...
        try:
            report = await fallback.generate(
                question, validation.normalized_sql, columns, rows
            )
...
class FilterPlanner:
    async def generate_filters(
        self, request: str, panels: List[DashboardPanel], db
                    ...
                    if f_type in ["dropdown", "multiselect"] and col and tab:
                        try:
                            ...
                            if tab.isidentifier() and col.isidentifier():
                                ...
                                table_valid = any(
                                    t.name == tab
                                    and any(c.name == col for c in t.columns)
                                    for t in schema
                                )
                                ...
                                if table_valid:
                                    ...
                                    logger.warning(
                                        f"Filter requested invalid table/column {tab}.{col}"
                                    )
                        except Exception as e:
                            logger.warning(
                                f"Failed to fetch filter options for {tab}.{col}",
                                error=str(e),
                            )
...
def _title_from_request(request: str) -> str:
    ...
    return (
        " ".join(w.capitalize() for w in words if w.lower() not in stop_words)
        or request[:60]
    )
