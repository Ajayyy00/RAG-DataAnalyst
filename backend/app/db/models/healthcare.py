...
class Facility(Base):
    ...
    departments: Mapped[List["Department"]] = relationship(
        "Department", back_populates="facility"
    )
...
class Department(Base):
    ...
    providers: Mapped[List["Provider"]] = relationship(
        "Provider", back_populates="department"
    )
    encounters: Mapped[List["Encounter"]] = relationship(
        "Encounter", back_populates="department"
    )
...
class Provider(Base):
    ...
    department: Mapped["Department"] = relationship(
        "Department", back_populates="providers"
    )
...
class Patient(Base):
    ...
    vital_signs: Mapped[List["VitalSign"]] = relationship(
        "VitalSign", back_populates="patient"
    )
...
class Encounter(Base):
    ...
    admit_date: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False, index=True
    )
    discharge_date: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    discharge_disp: Mapped[str | None] = mapped_column(
        String(100)
    )  # Home | SNF | Expired
    ...
    department: Mapped["Department"] = relationship(
        "Department", back_populates="encounters"
    )
    diagnoses: Mapped[List["Diagnosis"]] = relationship(
        "Diagnosis", back_populates="encounter"
    )
    procedures: Mapped[List["Procedure"]] = relationship(
        "Procedure", back_populates="encounter"
    )
    medications: Mapped[List["Medication"]] = relationship(
        "Medication", back_populates="encounter"
    )
    lab_results: Mapped[List["LabResult"]] = relationship(
        "LabResult", back_populates="encounter"
    )
    vital_signs: Mapped[List["VitalSign"]] = relationship(
        "VitalSign", back_populates="encounter"
    )
...
class Procedure(Base):
    ...
    encounter: Mapped["Encounter"] = relationship(
        "Encounter", back_populates="procedures"
    )
...
class Medication(Base):
    ...
    encounter: Mapped["Encounter"] = relationship(
        "Encounter", back_populates="medications"
    )
...
class LabResult(Base):
    ...
    encounter: Mapped["Encounter"] = relationship(
        "Encounter", back_populates="lab_results"
    )
...
class VitalSign(Base):
    ...
    encounter: Mapped["Encounter"] = relationship(
        "Encounter", back_populates="vital_signs"
    )
...
class Readmission(Base):
    ...
    index_encounter_id: Mapped[uuid.UUID] = mapped_column(
        ForeignKey("encounters.id"), nullable=False
    )
    readmit_encounter_id: Mapped[uuid.UUID] = mapped_column(
        ForeignKey("encounters.id"), nullable=False
    )
    patient_id: Mapped[uuid.UUID] = mapped_column(
        ForeignKey("patients.id"), nullable=False, index=True
